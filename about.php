                    ...
                    <div class="col-12">
                       <figure>
                            ...
                            <figcaption class="about_content">
                                ...
                                <p>"We are a digital agency dedicated to crafting meaningful content and intuitive user experiences that deliver real value to our clients and their audiences."</p>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single_chose">
                                ...
                                <div class="chose_content">
                                    ...
                                    <p>"Creative Design" refers to the process of generating unique and innovative visual or conceptual solutions to a problem or challenge. It goes beyond mere aesthetics, aiming to produce something that is not just visually appealing but also effective, functional, and original.</p>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single_chose">
                                ...
                                <div class="chose_content">
                                    ...
                                    <p>A "100% Money Back Guarantee" is a promise from a seller to a buyer that if they're not completely satisfied with a product or service, they can return it for a full refund of their purchase price, no questions asked.</p>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single_chose">
                                ...
                                <div class="chose_content">
                                    ...
                                    <p>"Online support 24/7" means customers can get help any time of day, any day of the week, through digital channels like chat, self-service FAQs, or email.</p>
                            ...
                            <article class="single_gallery_section">
                                <figure>
                                    ...
                                    <figcaption class="about_gallery_content">
                                       <h3>What do we do?</h3>
                                        <p>we specialize in providing high-quality auto spare parts for a wide range of vehicle makes and models. Whether you’re a mechanic, auto shop, or car owner, we are your reliable partner for all automotive parts and components.</p>
                                    </figcaption>
                                </figure>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <article class="single_gallery_section">
                                <figure>
                                    ...
                                    <figcaption class="about_gallery_content">
                                       <h3>Our Mission</h3>
                                        <p>Our mission at Auto Spare Parts is to provide reliable, high-quality, and affordable auto spare parts that keep vehicles running smoothly and safely. We are committed to supporting mechanics, auto shops, and vehicle owners by delivering excellent customer service, expert advice, and a comprehensive selection of parts for all makes and models.</p>
                                    </figcaption>
                                </figure>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <article class="single_gallery_section">
                                <figure>
                                    ...
                                    <figcaption class="about_gallery_content">
                                       <h3>History Of Us</h3>
                                        <p>Auto Spare Parts started with a simple goal — to make quality auto spare parts accessible and affordable for everyone. Since our founding in 1997, we’ve grown from a small local shop into a trusted supplier serving customers across cubao quezon city. With years of experience and a passion for cars, we continue to provide the parts you need, backed by service you can trust.</p>
                                    </figcaption>
                                </figure>
                            </article>
                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="faq-collapse1" class="collapse show" aria-expanded="true" role="tabpanel" data-parent="#faq-five">
                                    <div class="panel-body">
                                        ...
                                        <p>we offer FREE delivery on all orders within [your service area]. Whether you're a mechanic or a car owner, we’ll make sure your parts.
                                        </p>
                                        <p> arrive on time, every time — so you can get back on the road without delay.</p>
                                    </div>
                                </div>
                            </div>
                            <!--// Panel-default -->
