                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single_chose">
                                ...
                                <div class="chose_content">
                                    ...
                                    <p>means customers can get help any time of day, any day of the week, through digital channels like chat, self-service FAQs, or email.</p>
                            ...
                            <article class="single_gallery_section">
                                <figure>
                                    ...
                                    <figcaption class="about_gallery_content">
                                       <h3>What do we do?</h3>
                                        <p>The Philippine auto spare parts industry focuses on manufacturing specialized components (like wire harnesses for export), importing and distributing diverse parts, and catering to the domestic aftermarket for vehicle maintenance and repair. It's also increasingly adapting to electric vehicle (EV) technologies.</p>
                                    </figcaption>
                                </figure>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <article class="single_gallery_section">
                                <figure>
                                    ...
                                    <figcaption class="about_gallery_content">
                                       <h3>Our Mission</h3>
                                        <p>"To provide high-quality, reliable, and affordable auto spare parts to our customers, ensuring their vehicles operate safely and efficiently. We are committed to exceptional customer service, innovation, and sustainability in the automotive industry."</p>
                                    </figcaption>
                                </figure>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <article class="single_gallery_section">
                                <figure>
                                    ...
                                    <figcaption class="about_gallery_content">
                                       <h3>History Of Us</h3>
                                        <p>The Philippine auto spare parts industry began with local assembly in the 1950s, fostered by government import-substitution policies and local content requirements. While facing challenges from a relatively small domestic market and global competition, it has specialized in key areas like wire harnesses for export, and continues to evolve with the growing vehicle fleet and shift towards electric vehicles.</p>
                                    </figcaption>
                                </figure>
                            </article>
                        </div>
